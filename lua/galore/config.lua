...
config.values = {
  ...
  bufinit = {
    ...
    -- Or do both?
    saved = function(buffer) end,
    thread_message_browser = function(buffer) end,
    message_browser = function(buffer) end,
    thread_browser = function(buffer) end,
    message_view = function(buffer) end,
    thread_view = function(buffer) end,
