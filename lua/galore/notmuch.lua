...
function M.thread_get_toplevel_messages(thread)
  local messages =
    ffi.gc(nm.notmuch_thread_get_toplevel_messages(thread), nm.notmuch_messages_destroy)
...
function M.message_get_properties(message, key, exact)
  local it = ffi.gc(
    nm.notmuch_message_get_properties(message, key, exact),
    nm.notmuch_message_properties_destroy
  )
...
function M.directry_get_child_files(directory)
  local filenames =
    ffi.gc(nm.notmuch_directory_get_child_files(directory), nm.notmuch_filenames_destroy)
  return filename_iterator(filenames)
end
...
function M.directory_get_child_directories(directory)
  local filenames =
    ffi.gc(nm.notmuch_directory_get_child_directories(directory), nm.notmuch_filenames_destroy)
  return filename_iterator(filenames)
end
...
function M.config_get_values_string(db, key)
  local values =
    ffi.gc(nm.notmuch_config_get_values_string(db, key), nm.notmuch_config_values_destroy)
  return value_iterator(values)
end
--- @param db notmuch.Db
--- @param prefix string
